package org.example.crowdfunding.mvc.interceptor;


import org.example.crowdfunding.constant.CrowdFundingConstant;
import org.example.crowdfunding.entity.Admin;
import org.example.crowdfunding.exception.AccessForbiddenException;
...
public class LoginInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 从session域中取出Admin对象
        Admin admin = (Admin) session.getAttribute(CrowdFundingConstant.LOGIN_ADMIN_NAME);
